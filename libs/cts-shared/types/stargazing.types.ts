import { z } from 'zod';
import { StargazingListWithPagiSchema, singleStargazingDetail, stargazingItemBase, stargazingItemDetail, stargazingQuerySchema, updateStargazingDetailSchema } from '../schemas/stargazing.schemas';
