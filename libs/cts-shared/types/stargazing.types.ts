import { z } from 'zod';
import { StargazingListWithPagiSchema, singleStargazingDetail, stargazingItemBase, stargazingItemDetail, stargazingQuerySchema, switchStargazingQueryMode, updateStargazingDetailSchema } from '../schemas/stargazing.schemas';
