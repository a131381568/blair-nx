...
<template>
	<Header />
	<div class="filter-bg-opacity-20 w-table:filter-bg-opacity-50 laptop:filter-bg-opacity-none absolute right-0 top-0 z-0 mx-auto h-screen w-full bg-astrolabe bg-cover bg-right-bottom bg-no-repeat w-table:bg-contain" />
	<div class="z-10 mx-auto h-screen w-full">
		<div class="flex h-full items-stretch">
			...
			<div class="size-auto grow self-center text-white">
				<h1 class="font-serif tracking-normal mobile:capitalize middle-pc:text-8xl large-pc:text-9xl">
				...
				<h4
					class="mt-6 text-main-color-light mobile:text-lg h-table:w-380px h-table:text-lg middle-pc:w-auto large-pc:mt-10 large-pc:text-2xl"
					v-html="homeData.subPageTitle"
				/>
				<router-link
					class="home-read-more btn draw meet mt-8 inline-block large-pc:mt-12"
					to="/science"
				>
					<span>查看更多</span>
				</router-link>
